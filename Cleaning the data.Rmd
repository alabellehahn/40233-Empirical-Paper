...
clean_May2019$date <- as.yearmon(paste(clean_May2019$year, clean_May2019$month), "%Y %m") 
...
# Revising the month and year category into a parsable date
clean_August2019$date <- as.yearmon(paste(clean_August2019$year, clean_August2019$month), "%Y %m") 
```
...
# Revising the month and year category into a parsable date
clean_November2019$date <- as.yearmon(paste(clean_November2019$year, clean_November2019$month), "%Y %m") 
...
# Revising the month and year category into a parsable date
clean_February2020$date <- as.yearmon(paste(clean_February2020$year, clean_February2020$month), "%Y %m") 
...
clean_May2020$date <- as.yearmon(paste(clean_May2020$year, clean_May2020$month), "%Y %m") 
...
clean_August2020 $date <- as.yearmon(paste(clean_August2020$year, clean_August2020$month), "%Y %m") 
```
...
clean_November2020$date <- as.yearmon(paste(clean_November2020$year, clean_November2020$month), "%Y %m") 
...
clean_February2021$date <- as.yearmon(paste(clean_February2021$year, clean_February2021$month), "%Y %m") 
...
clean_May2021$date <- as.yearmon(paste(clean_May2021$year, clean_May2021$month), "%Y %m")
...
combined_months <- rbind(clean_May2019, clean_August2019, clean_November2019, clean_February2020, clean_May2020, clean_August2020, clean_November2020, clean_February2021, clean_May2021)
```
